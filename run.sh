...
handle_installation
conda activate ${COOKBOOK_CONDA_ENV}
ffmpeg -i $file_name temp.wav
insanely-fast-whisper --file-name temp.wav  --diarization_model pyannote/speaker-diarization-3.1 --min-speakers $min_speakers --transcript-path $output --hf-token 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
